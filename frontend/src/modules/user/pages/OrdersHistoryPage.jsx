                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-6 relative z-10">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          ></motion.span>
                          <span className="text-primary font-black text-[9px] tracking-[0.1em] uppercase leading-none mt-0.5">Live Processing</span>
                        </div>
                        <h3 className="text-xl font-black text-on-surface tracking-tighter leading-none">{order.id}</h3>
                        <p className="text-[9px] font-bold text-on-surface-variant uppercase tracking-widest opacity-50 mt-1.5">{order.date}</p>
                      </div>
                    ...
                    <div className="flex gap-3 relative z-10">
                      <motion.button 
                        ...
                        className="flex-1 bg-primary-gradient text-on-primary py-4 rounded-2xl font-headline font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20 flex items-center justify-center gap-2.5 transition-all"
                      >
                      ...
                      <motion.button 
                        whileTap={{ scale: 0.9 }}
                        className="p-4 bg-surface-container-low rounded-2xl text-on-surface-variant hover:bg-surface-container transition-colors shadow-inner"
                      >
                ...
                {pastOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      ...
                      <motion.button 
                        whileTap={{ scale: 0.95 }}
                        className="px-5 py-3.5 border border-outline-variant/20 text-on-surface-variant/60 rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-white transition-all shadow-sm"
                      >
                        Invoice
                      </motion.button>
                    </div>
